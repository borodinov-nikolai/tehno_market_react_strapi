  ...
  return (
    <Card style={{ width: '235px', }} onMouseEnter={()=>{setAnimation("animate__animated animate__headShake")}} onMouseLeave={()=>setAnimation("")} className={animation} data-item='item'>
      <Card.Body>
        ...
        <div className='d-flex justify-content-end'><Button onClick={()=>dispatch(addCartItem({id, name, price, img}))} className={styles.button} variant="primary">В корзину</Button></div>
      </Card.Body>
    </Card>
  )
}
